  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: '700px', margin: '0 auto' }}>
        ...
        {/* Section 1 */}
        <section style={{
          background: 'var(--bg-card)', padding: 'clamp(1rem, 3vw, 1.5rem)', borderRadius: '12px',
          border: '1px solid var(--border-light)', marginBottom: '1.2rem',
          ...
          <p style={{ lineHeight: 1.9, fontSize: 'clamp(13px, 2vw, 16px)', color: 'var(--text-main)' }}>
            ...
            {[
              ...
              <div key={step.num}>
                <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', marginBottom: '0.5rem' }}>
                  ...
                  <span style={{ color: 'var(--text-main)', fontSize: 'clamp(13px, 2vw, 15px)', lineHeight: 1.7 }}>
                    {step.text}
                  </span>
                </div>
                {step.code && (
        ...
        {/* Section 3 */}
        <section style={{
          background: 'rgba(216, 120, 88, 0.06)', padding: 'clamp(1rem, 3vw, 1.5rem)', borderRadius: '12px',
          border: '2px solid var(--primary)', marginBottom: '1.5rem',
        }}>
          <h2 style={{
            fontFamily: 'var(--font-pixel)', color: 'var(--primary)',
            fontSize: 'clamp(10px, 1.5vw, 13px)', marginBottom: '0.8rem',
        ...
        <div style={{ textAlign: 'center', paddingBottom: '1rem' }}>
          <a
            ...
            style={{
              ...
              padding: 'clamp(10px, 2vw, 14px) clamp(18px, 3vw, 28px)', borderRadius: '8px',
              fontFamily: 'var(--font-pixel)', fontSize: 'clamp(9px, 1.5vw, 11px)',
